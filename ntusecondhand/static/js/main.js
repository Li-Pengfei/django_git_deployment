...
MyMainAPP.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : "/static/img/image01.jpg", title : '<div class="slide-content">NTU Second Hand Exchange</div>', thumb : '', url : ''},
											{image : "/static/img/image02.jpg", title : '<div class="slide-content">NTU Second Hand Exchange</div>', thumb : '', url : ''},
											{image : "/static/img/image03.jpg", title : '<div class="slide-content">NTU Second Hand Exchange</div>', thumb : '', url : ''},
											{image : "/static/img/image04.jpg", title : '<div class="slide-content">NTU Second Hand Exchange</div>', thumb : '', url : ''}
									],
...
$(document).ready(function(){
	...
	MyMainAPP.nav();
	MyMainAPP.mobileNav();
	MyMainAPP.listenerMenu();
	MyMainAPP.menu();
	MyMainAPP.goSection();
	MyMainAPP.goUp();
	MyMainAPP.filter();
	MyMainAPP.fancyBox();
	MyMainAPP.contactForm();
	MyMainAPP.tweetFeed();
	MyMainAPP.scrollToTop();
	MyMainAPP.utils();
	MyMainAPP.accordion();
	MyMainAPP.toggle();
	MyMainAPP.toolTip();
